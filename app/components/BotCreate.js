...
function BotCreate() {
    ...
    function handleSubmit(e){
        ...
        axiosInstance.post('/bot/profile/', data, {appDispatch})
        .then(response => {
    ...
    <Page title="Create Bot">
      <form onSubmit={handleSubmit}>
        <div className="form-group">
          ...
          <CSSTransition in={!hasNameValue} timeout={10} classNames="liveValidateMessage" unmountOnExit>
                <div className="alert alert-danger small liveValidateMessage">Bot name is required! </div>
          </CSSTransition>
        </div>
        <div className="form-group">
          ...
          <input onChange={e => setAPIKey(e.target.value)} autoFocus name="apiKey" id="openai" className="form-control form-control-lg form-control-title" type="text" placeholder="" autoComplete="off" />
        </div>
